        ...
        'Wysihtml5' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/vendor/bootstrap-wysihtml5/js/bootstrap-wysihtml5.all.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '/vendor/bootstrap-wysihtml5/css/bootstrap-wysihtml5.min.css',
                ],
            ],
        ],
        'Select2' => [
        ...
        'Ckeditor' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/vendor/ckeditor/js/ckeditor.js',
                ],
            ],
        ],
        'Sweetalert2' => [
