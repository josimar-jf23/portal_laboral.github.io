                            ...
                            <tr>
                                ...
                                <td><table class="table-sm table-borderless">
                                    <tr>                                        
                                        ...
                                        <td>
                                            <form id="myform" action="{{ url('/admin/usuarios', ['id' => $r->id]) }}" method="post">
                                                
                                                <a href="#" class="btn-sm btn-danger" onclick="document.getElementById('myform').submit()"><i class='fas fa-trash'></i></a>
