            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.contactos.store') }}">
                    ...
                    <div class="form-group row">
                        <label for="empresa_id" class="col-md-4 col-form-label text-md-right">Emrpesa<span style="color:red">*</span></label>
                        <div class="col-md-6">                      
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="celular" type="text" class="form-control @error('celular') is-invalid @enderror" name="celular" value="" required>
                            @error('celular')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
